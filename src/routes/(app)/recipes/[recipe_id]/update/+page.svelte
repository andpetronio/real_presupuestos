...
<Card size="xl" class="mx-auto max-w-5xl p-6 md:p-8 shadow-sm">
  <h1 class="mb-1 text-xl font-bold text-gray-900">Editar receta</h1>
  <p class="mb-6 text-sm text-gray-600">Actualizá perro, datos de receta y materias primas asociadas.</p>
