...
describe('calculateBudgetTotals', () => {
  describe('basic calculation — single dog, single recipe, no operational costs, 20% margin', () => {
    it('verifies finalSalePrice = totalCost / (1 - margin)', () => {
      ...
      const recipeDailyCosts: ReadonlyArray<RecipeDailyCost> = [{ recipeId: 'r-1', dailyCost: 50 }];
    ...
    it('single dog gets all operational cost', () => {
      ...
      const recipeDailyCosts: ReadonlyArray<RecipeDailyCost> = [{ recipeId: 'r-1', dailyCost: 100 }];
  ...
  describe('operational total delegation', () => {
    it('operationalTotal matches what computeOperationalTotal produces', () => {
      ...
      const recipeDailyCosts: ReadonlyArray<RecipeDailyCost> = [{ recipeId: 'r-1', dailyCost: 30 }];
      const operationals: OperationalInputs = {
        vacuumBagSmallQty: 2,
        vacuumBagLargeQty: 1,
        labelsQty: 5,
      ...
      const expectedOps = computeOperationalTotal(operationals, defaultSettings);
  ...
  describe('dog totals structure', () => {
    it('each dog has all required fields', () => {
      ...
      const recipeDailyCosts: ReadonlyArray<RecipeDailyCost> = [{ recipeId: 'r-1', dailyCost: 25 }];
  ...
  describe('rounding — amounts are rounded to 2 decimals', () => {
    it('ingredient total is rounded to 2 decimals', () => {
      ...
      const recipeDailyCosts: ReadonlyArray<RecipeDailyCost> = [{ recipeId: 'r-1', dailyCost: 33.333 }];
